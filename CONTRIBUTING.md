...
Ready to contribute? Here's how to set up `ai-chat-game` for local development.

1. Fork the `ai-chat-game` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/ai-chat-game.git
    ```
